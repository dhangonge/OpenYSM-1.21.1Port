...
public final class TextureGrid extends OptionRow<Object> {
    ...
    private String currentTextureName() {
        ...
        return PlayerCapabilityProvider.get(mc.player).map(PlayerCapability::getCurrentTextureName).orElse(StringPool.EMPTY);
    }
    ...
    private void renderHolderPreview(GuiGraphics g, int x, int y, PlayerPreviewEntity holder, float pt) {
        ...
        ModelPreviewRenderer.renderLivingEntityPreview(g, x + TEX_BTN_W / 2.0f, y + TEX_BTN_H / 2.0f + 24.0f, 35.0f, mc.getFrameTimeNs() * 1e-9f, holder, RendererManager.getPlayerRenderer(), false, true);
    ...
    public void onClick(double mouseX, double mouseY) {
        ...
        PlayerCapabilityProvider.get(mc.player).ifPresent(cap -> {
            ...
            cap.initModelWithTexture(owner.modelId, name);
